...
public class list_nama extends AppCompatActivity {
    ...
    //array dari listnama mahasiswa
    private String[] mahasiswaArray = {
            "Paijo", "Alex", "Kokom", "Tyler", "Lanjay", "Deden", "Ujang", "Sarno", "Jong", "Titin", "Kiki"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mStartAsyncTask = findViewById(R.id.tombolMulai);
        //mambuat adapter array
        ...
        mStartAsyncTask.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //memproses adapter ketika di klik
    ...
    public class AddItemToListView extends AsyncTask<Void, String, Void> {
        ...
        protected void onPreExecute() {
            ...
            mProgressDialog.setTitle("Harap Tunggu");
